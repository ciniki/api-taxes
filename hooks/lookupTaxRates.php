...
// -------
//
function ciniki_taxes_hooks_lookupTaxRates($ciniki, $tnid, $args) {
    ...
    $strsql = "SELECT ciniki_tax_rates.id, "
        ...
        . "AND ciniki_tax_locations.start_postal_zip <= '" . ciniki_core_dbQuote($ciniki, $args['postal']) . "' "
        . "AND ciniki_tax_locations.end_postal_zip >= '" . ciniki_core_dbQuote($ciniki, $args['postal']) . "' "
